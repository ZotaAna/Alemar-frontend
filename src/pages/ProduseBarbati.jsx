...
export default function ProduseBarbati() {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_API_URL}/api/products`)
      .then((res) => res.json())
      .then((data) => {
        setProduse(data.filter((p) => p.gender === "men"));
        setLoading(false);
      })
      .catch((err) => {
  ...
  return (
    <div>
      ...
      <main className="produse-container produse-container--barbati">
        <div className="produse-header">
          <h1 className="produse-titlu">Parfumuri de Bărbați</h1>
        ...
        {loading ? (
          ...
          <div className="produse-empty"><p>Nu am găsit niciun produs.</p></div>
        ) : (
            ...
            {produseAfisate.map((produs) => (
              ...
              >
                ...
                <div className="produs-info">
                  ...
                  <p className="produs-pret">{(produs.price_cents / 100).toFixed(0)} {produs.currency}</p>
